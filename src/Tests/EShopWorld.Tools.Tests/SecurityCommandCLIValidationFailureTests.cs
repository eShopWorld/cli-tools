...
namespace EshopWorld.Tools.Tests
{
    ...
    {
        [InlineData("-a", "", "Command McMaster.Extensions.CommandLineUtils.CommandLineApplication`1[EShopWorld.Tools.Program] produced an error - Missing value for option 'a'")]
        ...
        [InlineData("-b", "", "Command McMaster.Extensions.CommandLineUtils.CommandLineApplication`1[EShopWorld.Tools.Program] produced an error - Missing value for option 'b'")]
        ...
        [InlineData("-c", "", "Command McMaster.Extensions.CommandLineUtils.CommandLineApplication`1[EShopWorld.Tools.Program] produced an error - Missing value for option 'c'")]
        [InlineData("-c", "1", "Master Key Strength must be either 2048, 3072 or 4096")]
        [InlineData("-e", "", "Command McMaster.Extensions.CommandLineUtils.CommandLineApplication`1[EShopWorld.Tools.Program] produced an error - Missing value for option 'e'")]
